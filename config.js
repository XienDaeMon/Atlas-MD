...
if (!gg) {
  gg = "6281269734000";   // You can Change this number //
}

// -------------------------------------------------------------- //


global.owner = gg.split("6281269734000");
...
global.packname = process.env.PACKNAME || `DemonBot`;
global.author = process.env.AUTHOR || "by: XienDaeMon";
